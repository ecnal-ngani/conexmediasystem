  ...
  return (
    <div className="space-y-6 md:space-y-8 max-w-[1600px] mx-auto pb-10 relative">
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-30 pointer-events-none">
        <button className="pointer-events-auto relative w-10 h-10 md:w-12 md:h-12 bg-[#E11D48] text-white rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-transform">
        ...
        <button className="pointer-events-auto w-10 h-10 md:w-12 md:h-12 bg-blue-600 text-white rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-transform">
      ...
      <div className="fixed bottom-4 left-4 z-30">
        <button className="w-7 h-7 bg-slate-800 text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform">
