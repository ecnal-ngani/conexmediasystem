    ...
    <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <Card className="border-2 shadow-lg bg-secondary/5">
            <CardHeader>
              <CardTitle className="text-lg flex items-center gap-2">
                <FileText className="w-5 h-5 text-primary" />
                Asset Briefing
              ...
              <CardDescription>
                Internal intelligence briefing for this classified asset.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="p-4 rounded-xl bg-white border-2 border-primary/10 text-sm leading-relaxed text-muted-foreground italic">
                Strategic brief for {content.title}. Please refer to the primary content body for full documentation.
              </div>
            </CardContent>
          </Card>
